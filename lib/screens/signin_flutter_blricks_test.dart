...
// import 'package:pulse_talk/image_paths.dart';
// import 'package:pulse_talk/app_colors.dart';
...
//                 textAlign: TextAlign.center,
//                 style: GoogleFonts.plusJakartaSans(
//                         fontSize: 14, fontWeight: FontWeight.w500, color: AppColor.kWhite)
...
//                               fontSize: 14, fontWeight: FontWeight.w500, color: AppColor.kWhite)
//                           .copyWith(
//                               color: AppColor.kPrimary, fontWeight: FontWeight.w600, fontSize: 14),
//                     ),
//                   )
//                 ],
//               ),
...
//         style: GoogleFonts.plusJakartaSans(
//                 fontSize: 14, fontWeight: FontWeight.w500, color: AppColor.kWhite)
//             .copyWith(color: AppColor.kGrayscale40, fontWeight: FontWeight.w500, fontSize: 14),
//         children: [
//           TextSpan(
//             text: title1,
//           ),
...
//                     fontSize: 14, fontWeight: FontWeight.w500, color: AppColor.kWhite)
//                 .copyWith(
//                     color: AppColor.kGrayscaleDark100, fontWeight: FontWeight.w500, fontSize: 14),
//           ),
//         ],
//       ),
//     );
...
//           style: GoogleFonts.plusJakartaSans(
//                   fontSize: 14, fontWeight: FontWeight.w500, color: AppColor.kWhite)
//               .copyWith(color: AppColor.kGrayscale40, fontWeight: FontWeight.w600, fontSize: 14),
//           children: <TextSpan>[
//             TextSpan(
//               text: subtitle,
...
//       {super.key, required this.onPressed, required this.title, required this.textStyle});
...
//                   fontSize: 14, fontWeight: FontWeight.w500, color: AppColor.kWhite)
//               .copyWith(
//                   color: AppColor.kGrayscaleDark100, fontWeight: FontWeight.w600, fontSize: 14),
